...
export default function Hero() {
  return (
    <section style={{
      ...
      {/* Background Video scaled up to hide the watermark */}
      <video
        autoPlay
        loop
        muted
      ...
      <div className="container animate-fade-in" style={{ width: '100%' }}>
        <div style={{ maxWidth: '800px', paddingRight: '1rem' }}>
          ...
          <h1 style={{ marginBottom: '1rem', fontSize: 'clamp(2rem, 5vw, 3.5rem)' }}>
            Dashboard e <span className="text-gradient">Simulador Econômico</span> para RPPNs Urbanas
          </h1>
          
          <p style={{ fontSize: '1.1rem', marginBottom: '2rem', maxWidth: '600px', color: 'var(--color-gray-100)' }}>
          ...
          <div className="hero-features" style={{ display: 'flex', gap: '2rem', marginTop: '2.5rem' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
              <div style={{ padding: '0.6rem', background: 'rgba(255,255,255,0.1)', borderRadius: '12px' }}>
                <Shield color="var(--color-forest-accent)" size={20} />
              </div>
              <div>
                <div style={{ fontWeight: 700, fontSize: '1rem' }}>Incentivo Fiscal</div>
                <div style={{ fontSize: '0.8rem', color: 'var(--color-gray-200)' }}>IPTU Verde & PSA</div>
              </div>
            </div>
            
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
              <div style={{ padding: '0.6rem', background: 'rgba(255,255,255,0.1)', borderRadius: '12px' }}>
                <Heart color="var(--color-forest-accent)" size={20} />
              </div>
              <div>
                <div style={{ fontWeight: 700, fontSize: '1rem' }}>Vida Melhor</div>
                <div style={{ fontSize: '0.8rem', color: 'var(--color-gray-200)' }}>Resiliência Climática</div>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Floating Logo - now it doesn't need to perfectly cover the watermark since the video is scaled */}
      <div style={{
        position: 'absolute',
        bottom: '20px',
        right: '20px',
